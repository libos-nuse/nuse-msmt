...
plot \
   '${OUTPUT}/py-coldstart-runc-docker-delay.dat' usi (0):(\$1)*1000:(\$2)*1000 w boxerr lt 1 lc rgb "green" fill pattern 2 title "runc", \
   '${OUTPUT}/py-coldstart-kata-runtime-docker-delay.dat' usi (1):(\$1)*1000:(\$2)*1000 w boxerr lt 1 lc rgb "gray" fill pattern 1 title "runv", \
   '${OUTPUT}/py-coldstart-runsc-ptrace-user-docker-delay.dat' usi (2):(\$1)*1000:(\$2*1000) w boxerr lt 1 lc rgb "blue" fill pattern 3 title "runsc(ptrace)", \
   '${OUTPUT}/py-coldstart-runsc-kvm-user-docker-delay.dat' usi (3):(\$1)*1000:(\$2)*1000 w boxerr lt 1 lc rgb "blue" fill pattern 5 title "runsc(kvm)", \
   '${OUTPUT}/py-coldstart-runu-docker-delay.dat' usi (4):(\$1)*1000:(\$2)*1000 w boxerr lt 1 lc rgb "cyan" fill pattern 4 title "runu", \
