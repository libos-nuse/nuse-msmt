...
plot \
   '${OUTPUT}/nginx-musl.dat' usin (\$0-0.3):1:2 w boxerrorbar  title "lkl", \
   '${OUTPUT}/nginx-docker.dat' usin (\$0+0):1:2 w boxerrorbar  title "docker" ,\
   '${OUTPUT}/nginx-native.dat' usin (\$0+0.3):1:2 w boxerrorbar  title "macos"
