...
plot \
   '${OUTPUT}/tcp-stream-musl-tap-bbr-fq-${SYS_MEM}.dat' usin (\$0-0.3):(\$1/1000):(\$2/1000) w boxerrorbar fill patter 0 title "LKL(bbr)", \
   '${OUTPUT}/tcp-stream-musl-tap-cubic-fq-${SYS_MEM}.dat' usin (\$0-0.1):(\$1/1000):(\$2/1000) w boxerrorbar fill patter 0 title "LKL(cubic)" ,\
