...
plot \
   '${OUTPUT}/${DIR}/tcp-rr-musl-tap.dat' usin (\$0-0.45):(\$1/1000):(\$2/1000) w boxerrorbar fill patter 0 title "LKL" , \
   '${OUTPUT}/${DIR}/tcp-rr-netbsd-tap.dat' usin (\$0-0.15):(\$1/1000):(\$2/1000) w boxerrorbar fill patter 0 title "LKL" , \
   '${OUTPUT}/${DIR}/tcp-rr-qemu-tap.dat' usin (\$0+0.15):(\$1/1000):(\$2/1000) w boxerrorbar fill patter 0 title "LKL+qemu" , \
   '${OUTPUT}/${DIR}/tcp-rr-native.dat' usin (\$0+0.45):(\$1/1000):(\$2/1000) w boxerrorbar fill patter 3 title "Linux"
