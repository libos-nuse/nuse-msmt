...
NETPERF_ARGS="-H ${DELAYED_DEST} -l10 -- -K bbr -o"
...
# printf based
LKL_HIJACK_DEBUG=1 LKL_HIJACK_MEMSIZE=1G \
...
# LKL_MEMSIZE=1G \
# RUMP_VERBOSE=1 \
# rexec ${LKLMUSL_NETPERF}/netperf tap:tap1 -- ${NETPERF_ARGS} | tee ${OUTPUT}/hrtimer/lkl-log.txt
